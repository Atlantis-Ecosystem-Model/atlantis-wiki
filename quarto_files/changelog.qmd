...
#### Corrected contaminant code

*July 23 - **6718** -  - Fulton, Beth (Environment, Hobart)*

Changed paths:
   M /Atlantis/trunk/atlantis/atecology/atdemography.c
   M /Atlantis/trunk/atlantis/atecology/atq10.c
Missed proportion of contaminant being transferred in atdemography.c
No real change in at10.c was a spacing issue

---

#### Fix missing break

*June 24 - **6717** -  - Fulton, Beth (Environment, Hobart)*
...
*May 10 - **6716** -  - Fulton, Beth (Environment, Hobart)*
...
*May 6 - **6715** -  - Fulton, Beth (Environment, Hobart)*
...
Updated the q10 to include a new CEATTLE option (setting 3 for q10_method)

---

#### Added contaminant handling

*March 30 - **6707** -  - Fulton, Beth (Environment, Hobart)*

Changed paths:
   M /Atlantis/trunk/atlantis/ConvertAtlantis/atBioltoXML.c
   M /Atlantis/trunk/atlantis/ConvertAtlantis/atManagetoXML.c
Added contaminant handling
...
*March 30 - **6706** -  - Fulton, Beth (Environment, Hobart)*
...
#### Changed reference to flagusingRedusR_HCR_id

*February 16 - **6704** -  - Fulton, Beth (Environment, Hobart)*
...
*January 29 - **6702** -  - Fulton, Beth (Environment, Hobart)*
...
*January 23 - **6701** -  - Fulton, Beth (Environment, Hobart)*
...
*January 8 - **6700** -  - Fulton, Beth (Environment, Hobart)*
...
*January 4 - **6699** -  - Fulton, Beth (Environment, Hobart)*
...
*November 28 - **6698** -  - Fulton, Beth (Environment, Hobart)*
...
Fixed some compile issues for Sonoma M2 Macs, added more to the tiered management code and corrected invertebrate movement memory bug

---

#### Explicit nutrient ratios

*November 6 - **6697** -  - Fulton, Beth (Environment, Hobart)*
...
#### Fix contaminant aging transfer

*October 17 - **6693** -  - Fulton, Beth (Environment, Hobart)*
...
Fix to atContaminants aging transfer as final boxes may be overwriting earlier boxes in the old way it was done.

---

#### Fix typo

*October 10 - **6691** -  - Fulton, Beth (Environment, Hobart)*
...
#### [MSE tiered management]

*October 5 - **6690** -  - Fulton, Beth (Environment, Hobart)*
...
#### [New harvest strategy options]

*October 3 - **6688** -  - Fulton, Beth (Environment, Hobart)*

Most of the additions are due to new harvest strategy options. Have also changed the handling of some migration and movement-related arrays. Should not change output in anyway but is a cleaner handling of memory.
...
*September 27 - **6685** -  - Fulton, Beth (Environment, Hobart)*
...
*November 9 - **"6683"** - Fulton, Beth (Environment, Hobart)*

#### Updated flag_replicated_old_PPmort
...
#### [Indicate which method to deal with temperature scalars]. 
*June 16 - **v6681** - - Fulton, Beth (Environment, Hobart)*
Setting to zero uses a simple Q10 based correction using 15'C reference. `q10_method_XXX 0`Changed paths: M /Atlantis/trunk/atlantis/ConvertAtlantis/atBioltoXML.c
